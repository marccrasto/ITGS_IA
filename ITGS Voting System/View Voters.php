...
<form action="View Voters.php" method="post" enctype="multipart/form-data" id="myForm" >
	<div class="header">
...
<a href="Index.php" class="active">Home</a>
  ...
  <a href="View Voters.php">View Voters</a>
  ...
  <a href="Poll Results.php" class="right">Poll Results</a>
	...
	<table>
                <tr>
                    <th width="8%">Voter_ID</th>
                    <th width="12%">First_Name</th>
                    <th width="15%">Last_Name</th>
                    <th width="14%">Gender</th>
                    <th width="14%">Email_ID</th>
                    <th width="14%">Date_Of_Birth</th>
...
if(isset($_POST['Searchbtn']))
{
    ...
    $query = "SELECT * FROM `tbl_registration` WHERE CONCAT(`Voter_ID`, `First_Name`, `Last_Name`, `Gender`, `Email_ID`, `Date_Of_Birth`, `Password`) LIKE '%".$valueToSearch."%'";
