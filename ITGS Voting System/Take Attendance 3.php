    ...
    return $filter_Result;
		...
		<?php $a=1; ?>
                <tr>
					...
					<td><input type="radio" name='<?php $row[$a]?>' value="1"/><label>Present</label>
				    <input type="radio" name='<?php $row[$a]?>' value="1"/><label>Absent</label></td>
                </tr>
				echo $a;
                <?php $a=$a+1; endwhile;?>
	  </table>
	  
<button type="button" class="registerbtn" name="enterbtn">Enter Attendance</button>
<button type="reset" class="registerbtn" name="resetbtn">Reset Attendance</button>
